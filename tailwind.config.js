  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "bismillah-fade-in": {
          "0%": { opacity: "0", transform: "translate3d(0, 0.35rem, 0) scale(0.99)" },
      ...
      animation: {
        ...
        "bismillah-fade-in": "bismillah-fade-in 0.8s cubic-bezier(0.22, 1, 0.36, 1) both",
        "bismillah-float": "bismillah-float 7s ease-in-out 0.8s infinite",
