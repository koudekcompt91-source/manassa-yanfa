...
import TeachersDiagnosticPanel from "@/components/student/TeachersDiagnosticPanel";
import { getTeachersSection } from "@/lib/paid-teachers-sections";

export default function TeachersDiagnosticPage() {
  const section = getTeachersSection("diagnostic");
